Clase 9 - Aplicación Slim Framework 4 PHP con despliegue automático en Heroku.
==============================

#### Ejemplo funcional
https://ejemplo-slim.herokuapp.com/
...
## 1- Forkear proyecto
Como primer paso, forkeamos [este proyecto](https://github.com/flippiJS/slim-php-mysql-heroku) desde el boton ubicado en la parte superior derecha de la pagina del repositorio.
...
**En caso de no poder crear una base en el dominio anterior, podemos utilizar https://www.freemysqlhosting.net/**
